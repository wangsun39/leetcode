| 时间 | 场次 | 题号 | 题目      | 难度 | 说明 |
|----|----|---------|-----|-----|--------|
|2023-3-17| 第336场周赛  | Q3  | [美丽子集的数目](https://leetcode.cn/problems/the-number-of-beautiful-subsets/) |       | 本周AK，这题当时用了暴力法，实际有更合理的方法|
|2023-3-12| 第335场周赛  | Q4  | [完成所有任务的最少时间](https://leetcode.cn/problems/minimum-time-to-complete-all-tasks/) |       | 比赛时没有想到这种常用的思想，按区间左右端点排序，然后在贪心|
