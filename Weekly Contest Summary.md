| 时间 | 场次 | 题号 | 题目      | 难度 | 说明 |
|----|----|---------|-----|-----|--------|
|2022-11-27| 第321场周赛  | Q4  | [统计中位数为 K 的子数组](https://leetcode.cn/problems/count-subarrays-with-median-k/) |       | 本周AK<br>前三题比较顺利，这题想了一会儿，最后考虑采用中心向左右拓展计算大于的元素个数-小于的元素个数的方法，再用哈希 |
