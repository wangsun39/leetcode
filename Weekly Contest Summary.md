| 时间 | 场次 | 题号 | 题目      | 难度 | 说明 |
|----|----|---------|-----|-----|--------|
|2022-10-16| 第315场周赛  | T4  | [对字母串可执行的最大删除数](https://leetcode.cn/problems/maximum-deletions-on-a-string/description/) |       | 本周前三题10分钟多点就完成了(wa了一次)，这题又被卡住了，知道比赛结束后才做出来，感觉并不难，开始想去双指针，后来考虑分区间，最后还是用类似"以某个下标结尾的区间个数"进行统计的方法 |
