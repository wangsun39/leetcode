...
def capital_gainloss(stocks: pd.DataFrame) -> pd.DataFrame:
    ...
    ans = (
        stocks
        .groupby(['stock_name'], dropna=False)  # 显式保留 NaN
        .agg(
...
# PostgreSQL
# select stock_name, sum(case operation when 'Buy' then -price
#                         else price end) capital_gain_loss from Stocks group by stock_name;
