...
class Solution:
    def numberOfRounds(self, startTime: str, finishTime: str) -> int:
        def calc(start, finish):
            h1, m1 = start.split(':')
            h2, m2 = finish.split(':')
            h1, m1, h2, m2 = int(h1), (int(m1) + 14) // 15, int(h2), int(m2) // 15
            res = (h2 - h1) * 4 + m2 - m1
            if res < 0:
                return 0
            return res
...
so = Solution()
print(so.numberOfRounds("00:47", "01:07"))
print(so.numberOfRounds("00:47", "00:57"))
print(so.numberOfRounds(startTime = "12:01", finishTime = "12:44"))
print(so.numberOfRounds(startTime = "20:00", finishTime = "06:00"))
