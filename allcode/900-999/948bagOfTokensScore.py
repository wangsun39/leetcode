...
so = Solution()
print(so.bagOfTokensScore(tokens = [100,200,300,400], power = 200))
print(so.bagOfTokensScore(tokens = [100], power = 50))
print(so.bagOfTokensScore(tokens = [200,100], power = 150))
