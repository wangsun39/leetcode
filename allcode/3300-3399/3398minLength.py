...
print(so.minLength(s = "000", numOps = 0))  # 3
print(so.minLength(s = "00", numOps = 0))  # 2
print(so.minLength(s = "0101010", numOps = 0))
print(so.minLength(s = "0000", numOps = 2))
print(so.minLength(s = "0101", numOps = 0))
